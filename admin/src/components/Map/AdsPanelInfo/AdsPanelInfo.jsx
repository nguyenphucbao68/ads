      ...
      <Flex gap={10}>
        ...
        <div>
          ...
          <Paragraph strong style={{ margin: 0 }}>
            <Text strong>{!adsPannelInfo ? 'Chưa có dữ liệu' : adsPannelInfo.ads_type.name}</Text>
          </Paragraph>
          ...
          <Paragraph>
            {adsPannelInfo && (
              <React.Fragment>
                ...
                {
                  <Text strong italic>
                    {adsPannelInfo.is_available ? 'ĐÃ QUY HOẠCH' : 'CHƯA QUY HOẠCH'}
                  </Text>
                }
              </React.Fragment>
            )}
...
AdsPanelInfo.propTypes = {
  adsPannelInfo: PropTypes.object,
}
